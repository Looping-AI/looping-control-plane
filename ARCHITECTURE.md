...
- **Execution envelope store**: `Map<nonce, EnvelopeRecord>` with turn linkage, workspace scope grants, expiry/revocation, and accepted engine dispatch version. File: [src/control-plane-core/models/workflow-envelope-model.mo](src/control-plane-core/models/workflow-envelope-model.mo).
